...
const DoorbellIcon = ({ id, width, height, fill, ...rest }: Props) => {
  return (
    <svg
      id={id ?? "DoorbellIcon"}
      data-test-id={id ?? "DoorbellIcon"}
